...
describe 'selinux' do
  ...
  context 'package' do
    ...
    context 'on RedHat 5 based OSes' do
      let(:facts) { { :operatingsystem => 'RedHat', :operatingsystemmajrelease => '5', :selinux_current_mode => 'enforcing' } }
    ...
    [ '6', '7' ].each do |majrelease|
      context "On RedHat #{majrelease} based OSes" do
        let(:facts) { { :operatingsystem => 'RedHat', :operatingsystemmajrelease => majrelease, :selinux_current_mode => 'enforcing' } }
